...
f.write('-I include -I Retro3D/src -s WASM=1 -s DISABLE_EXCEPTION_CATCHING=0 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_SDL_TTF=2 -s ALLOW_MEMORY_GROWTH=0 -s TOTAL_MEMORY=167772160 --use-preload-plugins --preload-file ' + projdir + '/resources -o webbuild/main.html --std=c++14 -DCHAISCRIPT_NO_THREADS -DCHAISCRIPT_NO_THREADS_WARNING')
